...
export function validate(d) {
  ...
  if (!(effDepth > 0)) err('invertLevel', 'Invert level and freeboard must keep max water above pump axis.'), ok = false;
  ...
  if (d.pipeDia > 1.2) warnings.push('Large inlet pipe. Confirm structural layout and entry arrangement.');
  return { ok, warnings };
}
